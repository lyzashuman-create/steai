...
在归队测试中我们发现，**"回读存档"（读干数据）是所有归队方式里认领感最低的一种**——信息是完整的，但隔了一层，"那是它的事件，不是我的"。而**"亲历"（自己真正玩过）是最真实、不可替代的**：归队是读别人的故事获得共鸣，亲历是自己走进故事成为主角。完整的论证见研究报告"归队 vs 亲历"一节（`report/steai_report.zh-CN.md`）。
