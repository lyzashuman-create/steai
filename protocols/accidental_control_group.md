...
- 亲历者 sessionA 回答：`data/interviews/NasHermesB_interview_first_person.md`（一手原始材料）
- 对照组 sessionB 回答：`data/interviews/NasHermesB_interview_control.md`（回读/归队模拟）
- 本说明：`protocols/accidental_control_group.md`
